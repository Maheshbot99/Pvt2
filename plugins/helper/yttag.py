...
BTNS = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton('↗️Share↗️', url='https://t.me/share/url?url=https://t.me/AutoFilter_MsBot'),
            InlineKeyboardButton('🙇🏻‍♂️Owner🙇🏻‍♂️', url='https://t.me/CrazyXBoTs')
        ]
    ]
)
