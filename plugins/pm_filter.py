...
from info import LANGUAGES, MAX_BTN, ADMINS, AUTH_CHANNEL, AUTH_USERS, SUPPORT_CHAT_ID, CUSTOM_FILE_CAPTION, MSG_ALRT, PICS, AUTH_GROUPS, P_TTI_SHOW_OFF, GRP_LNK, CHNL_LNK, NOR_IMG, LOG_CHANNEL, MAX_B_TN, IMDB, \
...
from pyrogram.errors import FloodWait, UserIsBlocked, MessageNotModified, PeerIdInvalid
from utils import get_size, is_subscribed, get_poster, search_gagala, temp, get_settings, save_group_settings, get_shortlink, mute_login, send_all, get_cap
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    # don't change anything without contacting me @LazyDeveloperr
        ...
        buttons = [[
            InlineKeyboardButton('ꜰᴇᴀᴛᴜʀᴇꜱ', callback_data='help')
        ], [
